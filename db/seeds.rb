...
cute.creatures.create(breed: 'catdog',
...
scary.creatures.create(breed: 'catspider',
...
funny.creatures.create(breed: 'wolfbird',
...
funny.creatures.create(breed: 'lemurdog',
